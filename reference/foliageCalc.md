...
Calculates foliage biomass or carbon per tree given either DBH or DBH
and Height. Calculations are done base on the allometric equations
provided in Ung et al., 2008 or Lambert et al., 2005. A species specific
decay class reduction factor can be applied (Harmon et al., 2011) if
desired.
...
``` r
foliageCalc(data = trees_data, eval = "ung_2", species = "LGTREE_NFI",
